(self["webpackChunksearch"] = self["webpackChunksearch"] || []).push([[406],{
...
function App() {
  return (0,emotion_react_jsx_runtime_browser_esm/* jsx */.tZ)(StyledApp, {
    children: (0,emotion_react_jsx_runtime_browser_esm/* jsx */.tZ)("h1", {
      children: "---- Search Navbar On top of the shop page ----"
    })
  });
}
;// CONCATENATED MODULE: ./src/search-remote-entry.ts
